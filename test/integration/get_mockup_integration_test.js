...
describe('Get Mockup', function () {
  ...
  const apiName = 'Test';  
  const apiAuth = [{"username": "telkom", "password": "da1c25d8-37c8-41b1-afe2-42dd4825bfea"}];
  const user = {"username": "telkom", "password": "da1c25d8-37c8-41b1-afe2-42dd4825bfea"};
