...
class PilihanTerbaik{
    async addNewPilihanTerbaik(payload){
        const data = [payload];
        let view = model.generalPilihanTerbaik();
        ...
        const document = view;
        const result = await command.insertOnePilihanTerbaik(document);

        return result;
    }

    async updatePilihanTerbaik(params, payload){
        const data = [payload];
        let view = model.generalPilihanTerbaik();
        ...
        const document = view;
        const result = await command.updateOnePilihanTerbaik(params, document);
        return result;
    }
