...
class MahirPrakerja{
    async addNewMahirPrakerja(payload){
        const data = [payload];
        let view = model.generalMahirPrakerja();
        ...
        const document = view;
        const result = await command.insertOneMahirPrakerja(document);

        return result;
    }

    async updateMahirPrakerja(params, payload){
        const data = [payload];
        let view = model.generalMahirPrakerja();
        ...
        const document = view;
        const result = await command.updateOneMahirPrakerja(params, document);
        return result;
    }
