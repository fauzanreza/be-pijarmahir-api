...
const isValidParamGetOneMahirPrakerja = async (payload) => {
    let constraints = {};
    let values = {};
...
const isValidParamGetAllMahirPrakerja = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
const isValidParamPostOneMahirPrakerja = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
const isValidParamUpdateOneMahirPrakerja = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
module.exports = {
    isValidParamPostOneMahirPrakerja: isValidParamPostOneMahirPrakerja,
    isValidParamGetOneMahirPrakerja: isValidParamGetOneMahirPrakerja,
    isValidParamGetAllMahirPrakerja: isValidParamGetAllMahirPrakerja,
    isValidParamUpdateOneMahirPrakerja:isValidParamUpdateOneMahirPrakerja
