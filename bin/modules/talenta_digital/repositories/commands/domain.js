...
class TalentaDigital{
    async addNewTalentaDigital(payload){
        const data = [payload];
        let view = model.generalTalentaDigital();
        ...
        const document = view;
        const result = await command.insertOneTalentaDigital(document);

        return result;
    }

    async updateTalentaDigital(params, payload){
        const data = [payload];
        let view = model.generalTalentaDigital();
        ...
        const document = view;
        const result = await command.updateOneTalentaDigital(params, document);
        return result;
    }
