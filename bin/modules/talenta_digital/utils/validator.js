...
const isValidParamGetOneTalentaDigital = async (payload) => {
    let constraints = {};
    let values = {};
...
const isValidParamGetAllTalentaDigital = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
const isValidParamPostOneTalentaDigital = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
const isValidParamUpdateOneTalentaDigital = async (payload) => {
    let constraints = {};
    let values = {};
    constraints[payload.fullname] = {length: {minimum: 5}};
    constraints[payload.teacher] = {length: {minimum: 4}};
...
module.exports = {
    isValidParamPostOneTalentaDigital: isValidParamPostOneTalentaDigital,
    isValidParamGetOneTalentaDigital: isValidParamGetOneTalentaDigital,
    isValidParamGetAllTalentaDigital: isValidParamGetAllTalentaDigital,
    isValidParamUpdateOneTalentaDigital:isValidParamUpdateOneTalentaDigital
